...
<body class="background-white">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-12  d-none d-lg-block text-right">
                                <div class="margin-tb-25px">
                                    <a href="#invitation" class="invitation-bot">
                                        Invitación
                                    </a>
                                </div>
                            </div>
    ...
    <div class="pull-top-70px">

        <div id="rev_slider_18_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="zawag-1" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            <!-- START REVOLUTION SLIDER 5.4.8.1 fullwidth mode -->
            <div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.8.1">
                <ul>
                    <!-- SLIDE  -->
                    <li data-index="rs-21" data-transition="papercut" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="assets/rslider/assets/beso-atardecer.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <!-- LAYER NR. 4 -->
                        <!--<div class="tp-caption rev-btn " id="slide-21-layer-4" data-x="['center','center','center','center']" data-hoffset="['0','0','2','7']" data-y="['top','top','top','top']" data-voffset="['620','554','642','494']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-responsive="off" data-frames='[{"delay":2270,"speed":1140,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"0","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgb(255,255,255);bg:rgb(169,54,115);bs:solid;bw:0 0 0 0;"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[15,15,15,15]" data-paddingright="[45,45,45,45]" data-paddingbottom="[15,15,15,15]" data-paddingleft="[45,45,45,45]" style="z-index: 8; white-space: nowrap; font-size: 17px; line-height: 17px; font-weight: 400; color: rgba(255,255,255,1); letter-spacing: 0px;font-family:Merienda;background-color:rgb(253,28,86);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">Confirme su asistencia </div>-->

                        <!-- LAYER NR. 5 -->
                        <div class="tp-caption   tp-resizeme" id="slide-21-layer-5" data-x="['center','center','center','center']" data-hoffset="['0','0','-2','0']" data-y="['top','top','top','top']" data-voffset="['313','155','294','212']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"delay":0,"speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 9;"><img src="assets/rslider/assets/e7b73-top-line.png" alt="" data-ww="['300px','300px','300px','300px']" data-hh="['40px','40px','40px','40px']" data-no-retina> </div>

                        <!-- LAYER NR. 6 -->
                        <div class="tp-caption   tp-resizeme" id="slide-21-layer-6" data-x="['center','center','center','center']" data-hoffset="['0','1','1','0']" data-y="['top','middle','middle','middle']" data-voffset="['705','268','286','237']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"delay":0,"speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 10;"><img src="assets/rslider/assets/c1170-bottom-line.png" alt="" data-ww="['300px','300px','300px','300px']" data-hh="['40px','40px','40px','40px']" data-no-retina> </div>
                    </li>
                </ul>
                    ...
                    <div class="bride-item layout-1 right">
                        ...
                        <div class="content">
                            ...
                            <!--<ul class="social-media">
                                ...
                                <li>
                                    <a class="twitter" href="https://twitter.com/ramirezaaron_">
    ...
    <section id="event" class="padding-top-150px padding-bottom-200px section-ba-2">
        ...
        <div class="container">
            <div class="section-title layout-1 light">
                <div class="discription">Queremos compartir contigo este momento tan importante</div>
    ...
    <section id="gallery" class="padding-tb-100px">
        <div class="container">
            <div class="section-title layout-1">
                ...
                <h2 class="title">Nuestra pequeña galería</h2>
                <div class="affter"></div>
            </div>
            ...
            <div class="row masonry-container">
                ...
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-1.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-1.jpg" alt=""></a>
                </div>
                <!--// item -->

                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-7.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-7.jpg" alt=""></a>
                </div>
                <!--// item -->

                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-2.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-2.jpg" alt=""></a>
                </div>
                <!--// item -->

                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-3.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-3.jpg" alt=""></a>
                </div>
                <!--// item -->
                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-8.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-8.jpg" alt=""></a>
                </div>
                <!--// item -->

                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-4.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-4.jpg" alt=""></a>
                </div>
                <!--// item -->
                ...
                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-9.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-9.jpg" alt=""></a>
                </div>
                <!--// item -->

                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-5.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-5.jpg" alt=""></a>
                </div>
                <!--// item -->

                <!-- item -->
                <div class="col-lg-4 col-md-6 item">
                    <a class="firo-gallery-item layout-1" href="assets/img/photos/photo-6.jpg" data-toggle="lightbox" data-gallery="example-gallery"><img src="assets/img/photos/photo-6.jpg" alt=""></a>
                </div>
                <!--// item -->
    ...
    <a href="#" class="go-top box-shadow background-main-color"><span class="arrow_carrot-up"></span></a>
